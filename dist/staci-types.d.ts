...
export interface Mappers<Store2 extends Values<Store2>> {
    ...
    mapMutations(mutations: Key<Store2['mutations']>[]): Vuex.Dictionary<Vuex.MutationMethod>;
    mapActions(actions: Key<Store2['actions']>[]): Vuex.Dictionary<Vuex.ActionMethod>;
